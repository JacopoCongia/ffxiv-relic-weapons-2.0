export default function Home() {
    return (
        <div
            className="flex flex-col pb-[5em] text-center font-[Cinzel] text-neutral-100 duration-[0.5s] min-[1000px]:pl-[250px]">
            <img
            ...
            />
            <div
                className="flex flex-col gap-[1em] px-[2em] text-[1.2rem] min-[600px]:gap-[0.3em] min-[600px]:text-[1.5rem]">
                <p>
                    Welcome to the{" "}
