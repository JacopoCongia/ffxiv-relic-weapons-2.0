...
function Navbar({ isVisible, setIsVisible }) {
  ...
  return (
    <div className="bg-navbar/[85%] sticky top-0 z-10 flex select-none items-center justify-center py-[2em] pl-[3em] text-center font-[Cinzel] text-neutral-100 backdrop-blur-md min-[1000px]:pl-0">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
