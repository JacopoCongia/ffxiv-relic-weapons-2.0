...
function Navbar({ isVisible, setIsVisible }) {
  return (
    <div
      ...
      className="drop-shadow-md sticky top-0 z-10 select-none items-center bg-[#1f1f1f] px-5 py-7 text-center font-bold  tracking-wider text-white"
    >
      {!isVisible ? (
      ...
      <Link
        to="/"
        className="m-auto text-[1rem] min-[520px]:m-0 min-[520px]:text-[1.5rem]"
      >
        Final Fantasy XIV{" "}
